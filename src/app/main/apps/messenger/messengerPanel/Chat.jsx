...
import { selectSelectedEmployeeId } from './messengerPanelSlice';
import {
...
function Chat(props) {
	...
	const { data: chat } = useGetMessengerChatQuery(selectedEmployeeId);
	...
	return (
		...
		>
			...
			}, [chat, messageText, selectedEmployeeId])}
		</Paper>
	);
}
