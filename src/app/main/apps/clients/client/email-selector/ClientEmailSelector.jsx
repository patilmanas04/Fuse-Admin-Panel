...
import { ClientEmailModel } from '../../models/ClientModel';
/**
 * The client email selector.
 */
const ClientEmailSelector = forwardRef((props, ref) => {
	...
	return (
		...
		>
			...
			<Button
				...
				onClick={() => value && onChange([...value, ClientEmailModel({})])}
			>
...
export default ClientEmailSelector;
