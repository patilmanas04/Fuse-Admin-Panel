...
function ProductsTable() {
	...
	const columns = useMemo(
		() => [
			...
			{
				accessorFn: (row) => row.membershipImage,
				id: 'membershipImage',
				header: '',
				enableColumnFilter: false,
				enableColumnDragging: false,
			...
			},
			{
				...
				accessorFn: (row) => `${row.membershipName}`
			},
			{
				accessorKey: 'days',
				header: 'Period(Days)',
	...
	const products = [
		...
		{
			membershipImage: 'image2.jpg',
			membershipName: 'Membership 2',
			days: 60,
			amount: 2000,
			status: 'Inactive'
		},
		{
			membershipImage: 'image3.jpg',
			membershipName: 'Membership 3',
			days: 90,
			amount: 3000,
			status: 'Active'
		}
